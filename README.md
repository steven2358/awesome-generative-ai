...
- [shekel](https://github.com/arieradle/shekel) - Runtime budget guardrails for AI agents. Prevents runaway LLM spend caused by retries, tool loops, and long-running agents. Supports OpenAI, Anthropic, Gemini, LangChain, LangGraph, CrewAI, AutoGen, LlamaIndex, MCP, and more. [#opensource](https://github.com/arieradle/shekel)
