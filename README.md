...
- [MOSS](https://mosscomputing.com) - Cryptographic signing for AI agents using ML-DSA-44 post-quantum signatures. Creates tamper-proof audit trails for attribution, compliance, and policy enforcement. [#opensource](https://github.com/mosscomputing/moss)
