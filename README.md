...
- [Enconvo](https://enconvo.com) - AI Agent Launcher for macOS with SmartBar, PopBar, voice input, live captions, TTS, knowledge base, custom workflows, and 100+ plugins supporting multiple LLM providers.
