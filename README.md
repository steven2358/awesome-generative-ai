...
- [MeetWave](https://meetwave.io) - Windows app that records meetings locally from system audio and generates summaries with action items, without a bot joining the call.
