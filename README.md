...
- [XVARY Stock Research](https://github.com/xvary-research/claude-code-stock-analysis-skill) - Claude Code skill for public SEC EDGAR + market data: thesis scoring, comparables, staleness rules. MIT. [#opensource](https://github.com/xvary-research/claude-code-stock-analysis-skill)
