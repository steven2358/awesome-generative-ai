...
- [Entroly](https://github.com/juyterman1000/entroly) - Local-first MCP tools for explicit-budget context selection, content-addressed exact recovery, and auditable Context Receipts. [#opensource](https://github.com/juyterman1000/entroly)
