...
- [BurnRate](https://github.com/burnrate-dev/burnrate) - Multi-provider AI coding cost analytics CLI that tracks token usage, costs, and optimization opportunities across Claude Code, Cursor, Copilot, Windsurf, Aider, Cline, and Codex. [#opensource](https://github.com/burnrate-dev/burnrate)
