...
- [Stable Diffusion Models](https://rentry.org/) - [NSFW] A comprehensive list of Stable Diffusion checkpoints on rentry.org.
...
- [podcast.ai](https://podcast.ai/) - A podcast that is entirely generated by artificial intelligence, powered by [Play.ht](https://play.ht/) text-to-voice AI.
