...
- [Fazm](https://fazm.ai) - The fastest AI computer agent for macOS. Takes voice commands and controls your entire desktop using direct DOM control at native speed. [#opensource](https://github.com/m13v/fazm)
