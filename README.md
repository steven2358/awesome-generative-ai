...
- [Taskade MCP Server](https://github.com/taskade/mcp) - An MCP server providing 62+ AI-powered tools for project management, tasks, and AI agents. Works with Claude, ChatGPT, Cursor, and all MCP clients. [#opensource](https://github.com/taskade/mcp)
