...
- [off-grid-mobile](https://github.com/alichherawalla/off-grid-mobile) - Open source app (React Native, MIT) to run LLMs, vision models, and Stable Diffusion fully on-device on iOS and Android. No internet required. [#opensource](https://github.com/alichherawalla/off-grid-mobile)
