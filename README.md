...
- [Token Diet](https://ranker.co.za/token-diet) - Free open-source prompt token counter. Count LLM tokens, trim prompts, cut AI API costs. Client-side only, no login.