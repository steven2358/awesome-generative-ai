...
- [Dassi](https://dassi.ai/) - An AI browser agent Chrome extension that automates work by clicking, filling forms, and navigating pages. Supports Claude, GPT, and Gemini via BYOK.
