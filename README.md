...
- [Anycode](https://github.com/anycode-ade/anycode) - High-performance web-based IDE with custom fast virtual-rendering code editor, Rust backend, LSP integration, and AI agent support via ACP. [#opensource](https://github.com/anycode-ade/anycode)
