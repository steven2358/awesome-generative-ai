...
- [Future AGI](https://futureagi.com/) - Open-source platform to simulate, evaluate, trace, guardrail, route, and optimize LLM and AI agent apps in one feedback loop, so agents don't just get monitored, they self-improve. Self-hostable. Apache-2.0. [#opensource](https://github.com/future-agi/future-agi)
