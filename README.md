...
- [DiscountedTokens](https://discountedtokens.com) - Cheap GPT-5.x API at up to 84% under OpenRouter list price; one key for OpenAI/Anthropic/Responses endpoints.
