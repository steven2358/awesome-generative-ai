...
- [Magic Hour](https://magichour.ai/) - One API and hosted MCP server for AI video generation (Sora 2, Veo 3.1, Kling 3.0, Seedance), face swap, lip sync and talking photo, with a free tier.
