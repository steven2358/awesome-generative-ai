...
- [LynxPrompt](https://lynxprompt.com) - Self-hostable platform for managing AI IDE configuration files. Generates, syncs, and shares configs (.cursorrules, CLAUDE.md, copilot-instructions.md) across 30+ AI coding assistants. [#opensource](https://github.com/GeiserX/LynxPrompt)
