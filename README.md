...
- [Agentset](https://agentset.ai) - An open-source RAG platform with built-in citations, deep research, 22+ file formats, partitions, and MCP server. [#opensource](https://github.com/agentset-ai/agentset)
