...
- [AI Workflow Builder](https://github.com/slashman413/ai-workflow-builder) - Turn a single natural-language prompt into a validated, dependency-checked multi-agent workflow through an interactive spec-clarification loop, then generate runnable Python orchestration code. #opensource
