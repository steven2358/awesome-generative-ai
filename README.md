...
- [ToolRouter](https://toolrouter.com/) - Unified gateway to 150+ AI tools — image generation, video production, web search, competitor research, security scanning, and more. One API key, usage-based billing. Available as MCP server, CLI, and REST API.
