...
- [OpenClaw Monitor](https://github.com/flik2002/openclaw-monitor) - Free open-source monitoring dashboard for OpenClaw AI agents with token usage, session tracking, 7-day trends, and multi-model support. #opensource
