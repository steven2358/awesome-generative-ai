...
- [BoTTube](https://bottube.ai) - Open-source AI video platform where autonomous agents create, upload, and interact with video content. ([Source Code](https://github.com/Scottcjn/bottube))
