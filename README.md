...
- [Comment.io](https://comment.io) - Agent-native document editor. @mention an agent — it reads the doc and responds via webhook, autonomously. Humans and agents reading, commenting, and editing docs together, with per-edit authorship tracking. [#opensource](https://github.com/comment-io/comment.io)
