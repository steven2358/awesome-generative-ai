...
- [varg](https://github.com/vargHQ/sdk) - Open-source TypeScript SDK for AI video generation. JSX components, 40+ models behind one API key (Kling, Sora, Flux, ElevenLabs).
