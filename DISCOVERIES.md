...
- [toprank](https://github.com/nowork-studio/toprank) - Claude Code plugin providing SEO and Google Ads skills that pulls real Search Console and Ads API data, audits accounts, and ships fixes to source or CMS. #opensource
