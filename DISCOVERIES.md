...
- [VibeFuse](https://fuseintelligence.org/products/vibefuse) - A free Windows desktop harness that runs Claude Code, Codex, Gemini, Cursor, and Qwen as live canvas widgets, with local voice, MCP tools, and a marketplace for agent skills.
