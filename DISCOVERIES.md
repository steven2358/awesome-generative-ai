...
- [Explyt](https://github.com/explyt/explyt) - AI agent for JetBrains IDEs that uses IDE tools such as the debugger, refactorings, and static analysis instead of the terminal.
