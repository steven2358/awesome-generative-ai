...
- [NovAI](https://aiapi-pro.com) - An OpenAI-compatible API gateway providing unified access to Chinese LLMs (DeepSeek, Qwen, GLM, Kimi, MiniMax) plus image and video generation on one endpoint.
