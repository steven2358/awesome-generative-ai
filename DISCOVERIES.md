...
- [XiuRouter](https://router.xiu.ai/) - A multi-model API router with OpenAI-compatible, Anthropic Messages, and Gemini endpoints, published per-token pricing, scoped API keys, and usage records.
