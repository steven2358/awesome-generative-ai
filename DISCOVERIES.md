...
- [LinguaPilot AI](https://getlinguapilot.com/) - Windows AI writing coach that corrects, improves and explains multilingual writing, helping users learn from corrections instead of only rewriting text.
