...
- [DevProjex](https://github.com/Avazbek22/DevProjex) - Builds controlled, redacted, token-efficient repository context for LLM workflows through GUI, TUI, CLI, and a read-only MCP server. #opensource
