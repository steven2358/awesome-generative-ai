...
- [Symbio](https://github.com/huyedits/Symbio) - A personal, autonomous, self-finetuning local MLX agent that learns from corrections and can't silently break itself. #opensource
