...
- [Seedance 2.5 free-tier data](https://github.com/nicoleiszsy/seedance-2-5-free-tier-data) - A dated dataset of what each channel grants on the Seedance 2.5 free tier: daily credits, generation caps, clip length, resolution, watermark behaviour, and API status.
