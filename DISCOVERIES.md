...
- [iLoveVideoEditor](https://ilovevideoeditor.com/) - Motion design engine for automated video production: render videos from JSON with templates, effects, and transitions; API and MCP server for AI agents.
