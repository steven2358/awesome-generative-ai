...
- [LLM-PQR](https://github.com/Amazed-Labs/llm-pqr) - A provider-neutral CLI for selecting models using measured quality, latency, cost, capabilities, and hard local-only constraints. #opensource
