...
- [TabGAN](https://github.com/Diyago/Tabular-data-generation) - A Python library for generating synthetic tabular data with GANs, diffusion models, and language models. #opensource
  - [APIClaw](https://apiclaw.biz) - Flat-rate OpenAI-compatible API for Claude, GPT, Kimi, Qwen, DeepSeek, and GLM ($19-$129/month, 50 free trial requests). Not affiliated with Anthropic or OpenAI.
